...
/**
 * Router unique pour les pages HTML (web) et les endpoints JSON (api).
 * Les contrôleurs peuvent renvoyer :
 *   - string          → HTML (route web)
 *   - Response        → JSON (route api)
 */
class Router
{
    ...
    {
        // Les navigateurs n'envoient pas DELETE nativement : on accepte ?_method=DELETE
